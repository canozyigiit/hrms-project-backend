...
public interface AuthService {
    ...
    Result registerForEmployer(RegisterEmployerRegisterDto registerEmployerDto);
    Result registerForJobSeeker(RegisterJobSeekerRegisterDto registerJobSeekerDto);
