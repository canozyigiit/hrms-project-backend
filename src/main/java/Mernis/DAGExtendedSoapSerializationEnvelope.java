...
public class DAGExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(DAGDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new DAGStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static DAGDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static DAGDateTimeConverter dateTimeConverter = new DAGStandardDateTimeConverter();

    public DAGExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public DAGExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new DAGMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=DAGHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,DAGExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=DAGHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
