...
public class DAGKPSPublicSoap
{
    ...
    public DAGKPSPublicSoap(){}

    public DAGKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public DAGKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        DAGExtendedSoapSerializationEnvelope envelope= new DAGExtendedSoapSerializationEnvelope(DAGExtendedSoapSerializationEnvelope.VER11);
